...
import com.lesnyg.mvvmexam1.databinding.FragmentSeekbarBinding;
...
public class SeekbarFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        final SeekbarViewModel viewModel = new ViewModelProvider(requireActivity()).get(SeekbarViewModel.class);
